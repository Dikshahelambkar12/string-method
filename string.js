...
count=0;
let str4 = prompt("Enter your name");
for ("let var of str:");{
    if str4.includes(the) {
        count=count+1
        }
}
...
//let str10 = " Hi my name is Diksha";
